...
export default function ThemeToggle() {
  ...
  try {
    ...
    return (
      <div className="relative inline-flex h-8 w-14 items-center rounded-full bg-gray-200">
        ...
        <span className="inline-block h-6 w-6 transform translate-x-1 rounded-full bg-white shadow-md" />
      </div>
    );
  }
